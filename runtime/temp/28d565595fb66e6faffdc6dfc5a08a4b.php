<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:103:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/provider/work_details.html";i:1557037365;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1553750080;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1553750080;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="col-sm-4 text-center">
                        ...
                        <button type="button" class="btn btn-primary" data-target="#myModal" data-toggle="modal" >工单评分</button>
                        <?php endif; if($provider['state'] == 3 && $provider['gid'] != 0): ?>
                        ...
                        <button type="button" class="btn btn-primary"  onclick='delWork("<?php echo $provider['id']; ?>","<?php echo $provider['title']; ?>")' >关闭工单</button>
                        <?php endif; if($provider['state'] == 2): ?>
                        <button type="button" class="btn btn-white btn-xs">已接单</button>
                        <?php endif; if($provider['state'] == 3): ?>
                        <button type="button" class="btn btn-white btn-xs">已结单</button>
                        <?php endif; if($provider['state'] == 4): ?>
                        <button type="button" class="btn btn-white btn-xs"   >已关闭</button>
                        <?php endif; ?>
                    </div>
                ...
                <div class="modal-body">
                    <form class="form-horizontal m-t" id="forms">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input  name="speed" class="form-control" type="number" maxlength="2" value="0">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">*上门服务仪表：</label>
                            <div class="col-sm-8">
                                <input  name="meter" class="form-control" type="number" maxlength="2" value="0">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">*上门服务内容：</label>
                            <div class="col-sm-8">
                                <input  name="details" class="form-control" type="number" maxlength="2" value="0">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">*上门服务用语：</label>
                            <div class="col-sm-8">
                                <input  name="term" class="form-control" type="number" maxlength="2" value="0">
                            </div>
                        </div>
                        <input  name="id" class="form-control" type="hidden" value="<?php echo $provider['id']; ?>">
                    </form>
                </div>
                <div class="modal-footer">
                    <center>
                        <button type="button" class="btn btn-white" data-dismiss="modal">关闭</button>
                        <button type="button" class="btn btn-primary" onclick="addGrade()">保存</button>
                    </center>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content animated fadeIn">
                ...
                <div class="modal-footer">
                    <center>
                        <button type="button" class="btn btn-white" data-dismiss="modal">关闭</button>
                        <button type="button" class="btn btn-primary" onclick="saveGrade()">修改</button>
                    </center>
                </div>
            </div>
        </div>
