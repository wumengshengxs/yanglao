                ...
                <div class="ibox-content">
                    <div class="btn-group search">
                        ...
                        <div class="dropdown-menu">
                            <form class="form-horizontal" action="/index/Works/order" method="get">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="radio radio-success radio-inline">
                                            <input type="radio" id="state<?php echo $key; ?>" value="<?php echo $key; ?>" name="state" <?php if($param['state'] == $key): ?> checked <?php endif; ?>>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">办结原因</label>
                                    <div class="col-sm-9">
                                        <?php if(is_array($work_result) || $work_result instanceof \think\Collection || $work_result instanceof \think\Paginator): $k = 0; $__LIST__ = $work_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($k % 2 );++$k;?>
                                        <div class="radio radio-success radio-inline">
                                            <input type="radio" id="result<?php echo $k; ?>" value="<?php echo $k; ?>" <?php if($param['result'] == $k): ?> checked <?php endif; ?> name="result">
                                            <label for="result<?php echo $k; ?>"> <?php echo $r; ?> </label>
                                        </div>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                                </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <?php if(is_array($order['data']) || $order['data'] instanceof \think\Collection || $order['data'] instanceof \think\Paginator): $k = 0; $__LIST__ = $order['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                        <tr>
                            <td><?php echo $k; ?></td>
                            ...
                            <td>
                                <a href="/index/works/workInfo?id=<?php echo $vo['id']; ?>">查看</a>
                                <?php if($vo['state'] == '未受理'): ?>
                                &nbsp;&nbsp;
                                <a href="javascript:acceptWork();">受理</a>
                                <?php endif; if(in_array($vo['state'],['受理中','已退回'])): ?>
                                &nbsp;&nbsp;
                                <a href="/index/works/workInfo?id=<?php echo $vo['id']; ?>">继续受理</a>
                                <?php endif; if(in_array($vo['state'],['未受理','受理中','已退回'])): ?>
                                &nbsp;&nbsp;
                                <a href="javascript:;">转交</a>
                                &nbsp;&nbsp;
                                <a href="javascript:;">关闭</a>
                                <?php endif; if(in_array($vo['state'],['已办结','已关闭','已通过'])): ?>
                                &nbsp;&nbsp;
                                <a href="javascript:;">重新打开</a>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    ...
                    <div class="text-center">总共 <?php echo $order['total']; ?> 条数据</div>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="/public/static/js/work/work_new.js"></script>
