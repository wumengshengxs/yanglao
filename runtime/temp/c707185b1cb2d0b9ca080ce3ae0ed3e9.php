<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:94:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/work/quality.html";i:1551665224;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1553750080;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1553750080;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <div class="btn-group search">
                        ...
                        <div class="dropdown-menu">
                            <form class="form-horizontal" action="/index/Work/quality" method="get">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td><?php echo date('Y-m-d H:i:s',$vo['finish_time']); ?></td>
                            <td><?php echo $vo['userName']; ?></td>
                            <td><?php echo (isset($vo['display_name']) && ($vo['display_name'] !== '')?$vo['display_name']:'--'); ?></td>
                            <td><?php echo $vo['type']; ?></td>
                            <td><?php echo $vo['handle_time']; ?></td>
                            <td>
                                <a href="/index/Work/workDetails?id=<?php echo $vo['id']; ?>&action=quality">工单质检</a>
                            </td>
                        </tr>
