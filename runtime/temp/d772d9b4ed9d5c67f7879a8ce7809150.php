<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/work/plan_group.html";i:1551665224;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1553750080;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1553750080;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-content">
            <div class="ibox-title">
                <h5>
                    <a class="btn btn-white btn-sm" href="<?php echo url('/index/Work/addPlanGroup'); ?>" ><i class="fa fa-plus"></i> 创建计划任务</a>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-daterange input-group">
                                                <input type="text" value="<?php echo $param['start_create']; ?>" class="input-sm form-control times" name="start_create"/>
                                                <span class="input-group-addon">到</span>
                                                <input type="text" value="<?php echo $param['end_create']; ?>" class="input-sm form-control times" name="end_create"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="name" value="<?php echo $param['name']; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="radio radio-success radio-inline">
                                                <input type="radio" id="state1" value="1" <?php if($param['state'] == 1): ?> checked <?php endif; ?> name="state">
                                                <label for="state1"> 启用 </label>
                                            </div>
                                            <div class="radio radio-success radio-inline">
                                                <input type="radio" id="state2" value="2" name="state" <?php if($param['state'] == 2): ?> checked <?php endif; ?>>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td><?php if($vo['state'] == 1): ?> 启用 <?php else: ?> 草稿 <?php endif; ?></td>
                                <td>
                                    <a href="/index/Work/planGroupDetails?id=<?php echo $vo['id']; ?>">查看</a>&nbsp;&nbsp;
