<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/client/physical.html";i:1547789743;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1547601686;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1547707416;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content c-physical">
            ...
            <div class="col-sm-12">
                <div class="ibox-title">
                    <h5>
                        <button class="btn btn-white btn-sm a-physical"><i class="fa fa-plus"></i> 添加体检记录</button>
                    </h5>
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                <?php if(is_array($physical['data']) || $physical['data'] instanceof \think\Collection || $physical['data'] instanceof \think\Paginator): $k = 0; $__LIST__ = $physical['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($k % 2 );++$k;?>
                                <tr>
                                    <td><?php echo $k; ?></td>
                                    <td><?php echo $p['institution']; ?></td>
                                    <td><?php echo $p['physical_time']; ?></td>
                                    <td>
                                        <?php if($p['image_count'] != 0): ?>
                                        <a href="javascript:;" onclick="viewImage(this)" data-image='<?php echo json_encode($p['image']); ?>' title="点击查看图片"><?php echo $p['image_count']; ?></a>
                                        <?php else: ?>
                                        <?php echo $p['image_count']; endif; ?>
                                    </td>
                                    <td><?php echo $p['remarks']; ?></td>
                                    <td>
                                        <a href="javascript:;" class="e-physical" title="编辑"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                        <a href="javascript:;" class="d-physical" title="删除"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                </tbody>
                            </table>
                            <div class="page"><?php echo $page; ?> <div><?php echo $physical['last_page']; ?>页，总共<?php echo $physical['total']; ?>条数据</div></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    var $userId = '<?php echo $userId; ?>',
        $physicalList = '<?php echo json_encode($physical["data"]); ?>';
</script>
</html>