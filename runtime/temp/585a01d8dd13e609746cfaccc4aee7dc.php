<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/auth/user.html";i:1551665224;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1553750080;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1553750080;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                <h5>
                    <button class="btn btn-white btn-sm a-user"><i class="fa fa-plus"></i> 添加管理员</button>
                </h5>
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($user) || $user instanceof \think\Collection || $user instanceof \think\Paginator): $k = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$u): $mod = ($k % 2 );++$k;?>
                    <tr>
                        <td><?php echo $k; ?></td>
                        ...
                        <td><?php echo $u['u_status']; ?></td>
                        <td><?php echo $u['remarks']; ?></td>
                        <td><?php echo $u['create_time']; ?></td>
                        <td>
                            <?php if($u['id'] != 1): ?>
                            <a href="javascript:;" class="e-user"><i class="fa fa-edit"></i></a>
                            <?php endif; ?>
                        </td>
                    </tr>
...
<script type="text/javascript">
    var $userList = '<?php echo json_encode($user); ?>',
        $roleList = '<?php echo json_encode($role); ?>';
</script>
</html>