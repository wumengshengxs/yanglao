<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:96:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/device/passage.html";i:1551665224;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1553750080;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1553750080;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-content">
            <div class="ibox-title">
                <h5>
                    <button class="btn btn-white btn-sm a-passage"><i class="fa fa-plus"></i> 添加通道</button>
                </h5>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($passage['data']) || $passage['data'] instanceof \think\Collection || $passage['data'] instanceof \think\Paginator): $k = 0; $__LIST__ = $passage['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($k % 2 );++$k;?>
                            <tr>
                                <td><?php echo $k; ?></td>
                                <td><?php echo $p['name']; ?></td>
                                <td><?php echo $p['param']; ?></td>
                                <td><?php echo $p['status']; ?></td>
                                <td><?php echo $p['create_time']; ?></td>
                                <td>
                                    <button type="button" class="btn btn-white e-passage">编辑</button>
                                </td>
                            </tr>
                    ...
                    <div class="page"><?php echo $page; ?> <?php echo $passage['total']; ?>条数据，共<?php echo $passage['last_page']; ?>页</div>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    var $devicePassage = '<?php echo json_encode($passage["data"]); ?>';
</script>
</html>