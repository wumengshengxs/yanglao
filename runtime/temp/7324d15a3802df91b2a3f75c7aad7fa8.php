<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:94:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/client/group.html";i:1551665224;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1553750080;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1553750080;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-content">
            <div class="ibox-title">
                <h5>
                    <button class="btn btn-white btn-sm a-group"><i class="fa fa-plus"></i> 添加分组</button>
                </h5>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($group['data']) || $group['data'] instanceof \think\Collection || $group['data'] instanceof \think\Paginator): $k = 0; $__LIST__ = $group['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($k % 2 );++$k;?>
                            <tr>
                                <td><?php echo $k; ?></td>
                                <td><?php echo $g['name']; ?></td>
                                <td><?php echo $g['remarks']; ?></td>
                                <td><?php echo $g['create_time']; ?></td>
                                <td>
                                    <a href="javascript:;" class="e-group" title="编辑"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                    <a href="javascript:;" class="d-group" title="删除"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
                        </table>
                        <div class="page"><?php echo $page; ?> <div><?php echo $group['last_page']; ?>页，总共<?php echo $group['total']; ?>条数据</div></div>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    var $groupList = '<?php echo json_encode($group["data"]); ?>';
</script>
</html>