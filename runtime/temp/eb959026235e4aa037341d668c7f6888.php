<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:100:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/client/case_record.html";i:1547789743;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1547601686;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1547707416;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content c-case-record">
            ...
            <div class="col-sm-12">
                <div class="ibox-title">
                    <h5>
                        <button class="btn btn-white btn-sm a-case-record"><i class="fa fa-plus"></i> 添加病历存档</button>
                    </h5>
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                <?php if(is_array($case['data']) || $case['data'] instanceof \think\Collection || $case['data'] instanceof \think\Paginator): $k = 0; $__LIST__ = $case['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($k % 2 );++$k;?>
                                <tr>
                                    <td><?php echo $k; ?></td>
                                    <td><?php echo $c['institution']; ?></td>
                                    <td><?php echo $c['case_time']; ?></td>
                                    <td>
                                        <?php if($c['count_img'] != 0): ?>
                                        <a href="javascript:;" onclick="viewImage(this)" data-image='<?php echo json_encode($c['image']); ?>' title="点击查看"><?php echo $c['count_img']; ?></a>
                                        <?php else: ?>
                                        <?php echo $c['count_img']; endif; ?>
                                    </td>
                                    <td><?php echo $c['remarks']; ?></td>
                                    <td>
                                        <a href="javascript:;" class="e-case-record" title="编辑"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                        <a href="javascript:;" class="d-case-record" title="删除"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                </tbody>
                            </table>
                            <div class="page"><?php echo $page; ?> <div><?php echo $case['last_page']; ?>页，总共<?php echo $case['total']; ?>条数据</div></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    var $userId = '<?php echo $userId; ?>',
        $caseRecordList = '<?php echo json_encode($case["data"]); ?>';
</script>
</html>