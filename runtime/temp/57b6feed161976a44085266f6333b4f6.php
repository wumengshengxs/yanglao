<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:96:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/articles/group.html";i:1548150341;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1553750080;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1553750080;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-content">
            <div class="ibox-title">
                <h5>
                    <button class="btn btn-white btn-sm" data-target="#myModal4" data-toggle="modal"><i class="fa fa-plus"></i> 添加类型</button>
                </h5>
            </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal m-t" id="forms">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control m-b" name="pid" id="list">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input  name="name" class="form-control" type="text"  maxlength="16" placeholder="类型名称">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input  name="weight" class="form-control" value="0" type="number">
                        </div>
                    </div>
