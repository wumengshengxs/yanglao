<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:101:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/work/add_plan_group.html";i:1551665224;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1553750080;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1553750080;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <small>计划任务&nbsp;>&nbsp;新建计划任务</small>
                    <a href="javascript:history.back(-1);" title="返回上一页"><i class="fa fa-reply"></i></a>
                </div>
            </div>
            <div class="ibox-content">
                <form class="form-horizontal form-plan">
                    <div class="form-group">
                        <label class="col-sm-1 control-label">计划组名称</label>
                        <div class="col-sm-5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group date">
                                <input type="text" name="start_time" class="form-control times">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group date">
                                <input type="text" name="end_time" class="form-control times">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-1 control-label">服务对象</label>
                        <div class="col-sm-5">
                            <input type="hidden" name="client" value="">
                            <span class="ng-binding">已选：<span id="nums">0</span>人</span>
                            <a class="btn btn-white btn-xs b-grant-workPlan" >
                                <i class="fa fa-plus"></i>&nbsp;&nbsp;服务对象
                            </a>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-1 control-label">分配话务员</label>
                        <div class="col-sm-5">
                            <?php if(is_array($staff) || $staff instanceof \think\Collection || $staff instanceof \think\Paginator): $i = 0; $__LIST__ = $staff;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?>
                            <div class="checkbox checkbox-success checkbox-inline">
                                <input type="checkbox" id="staff<?php echo $key; ?>" name="staff[]" value="<?php echo $s['number']; ?>">
                                <label for="staff<?php echo $key; ?>"> <?php echo $s['display_name']; ?> </label>
                            </div>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-1 control-label">分配策略</label>
                        <div class="col-sm-5">
                            <div class="radio radio-success radio-inline">
                                <input type="radio" id="allot" name="allot" value="1" checked>
                                <label for="allot"> 平均分配 </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-1 control-label">计划组状态</label>
                        <div class="col-sm-5">
                            <div class="radio radio-success radio-inline">
                                <input type="radio" id="state1" name="state" value="1" checked>
