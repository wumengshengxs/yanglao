<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:102:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/integration/integral.html";i:1551665224;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1553750080;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1553750080;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-daterange input-group">
                                            <input type="number" class="input-sm form-control " name="start" id="start" value="<?php echo $param['start']; ?>" />
                                            <span class="input-group-addon">至</span>
                                            <input type="number" class="input-sm form-control " name="end" id="end" value="<?php echo $param['end']; ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td><?php echo (isset($vo['groupName']) && ($vo['groupName'] !== '')?$vo['groupName']:'--'); ?></td>
                            <td><?php echo (isset($vo['tagName']) && ($vo['tagName'] !== '')?$vo['tagName']:'--'); ?></td>
                            <td><?php echo $vo['integral']; ?></td>
                            <td>
                                <a href="/index/Client/integral?id=<?php echo $vo['id']; ?>&type=0">查看</a>
                            </td>
                        </tr>
...
<script type="text/javascript" src="/public/static/js/integral/integral.js"></script>
</html>