<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:103:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/provider/details_work.html";i:1556161899;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1553750080;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1553750080;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                <?php if(is_array($work['work']['data']) || $work['work']['data'] instanceof \think\Collection || $work['work']['data'] instanceof \think\Paginator): $k = 0; $__LIST__ = $work['work']['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                                <tr>
                                    <td><?php echo $k; ?></td>
                            ...
                            <div class="page"><?php echo $work['page']; ?></div>
                            <div class="text-center"><?php echo $work['work']['last_page']; ?>页，总共<?php echo $work['work']['total']; ?>条数据</div>
                        </div>
                    </div>
                </div>
            </div>
