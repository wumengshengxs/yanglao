<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:95:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/healthy/index.html";i:1551665224;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1553750080;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1553750080;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <h5>
                    <div class="btn-group search">
                        ...
                        <div class="dropdown-menu">
                            <form class="form-horizontal" action="/index/Healthy/index" method="get">
                                ...
                                <!--<div class="form-group">-->
                                <!--<label class="col-sm-3 control-label">腕表是否发放</label>-->
                                <!--<div class="col-sm-9">-->
                                <!--<div class="radio radio-success radio-inline">-->
                                <!--<input type="radio" id="iswatch_send1" value="1" name="iswatch_send">-->
                                <!--<label for="iswatch_send1"> 是 </label>-->
                                <!--</div>-->
                                <!--<div class="radio radio-success radio-inline">-->
                                <!--<input type="radio" id="iswatch_send2" value="2" name="iswatch_send">-->
                                <!--<label for="iswatch_send2"> 否 </label>-->
                                <!--</div>-->
                                <!--</div>-->
                                <!--</div>-->
                                <!--<div class="form-group">-->
                                <!--<label class="col-sm-3 control-label">腕表发放时间</label>-->
                                <!--<div class="col-sm-4">-->
                                <!--<input type="text" name="start_send_time" value="<?php echo $param['start_send_time']; ?>" class="form-control">-->
                                <!--</div>-->
                                <!--<div class="col-sm-1 middle-div">至</div>-->
                                <!--<div class="col-sm-4 f-right">-->
                                <!--<input type="text" name="end_send_time" value="<?php echo $param['end_send_time']; ?>" class="form-control">-->
                                <!--</div>-->
                                <!--</div>-->
                ...
                <div class="col-sm-12">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($healthy['data']) || $healthy['data'] instanceof \think\Collection || $healthy['data'] instanceof \think\Paginator): $k = 0; $__LIST__ = $healthy['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$h): $mod = ($k % 2 );++$k;?>
                            <tr>
                                <td><?php echo $k; ?></td>
                                <td><a href="/index/Client/healthy?view=healthyBase&id=<?php echo $h['clientId']; ?>" title="点击查看详情"><?php echo $h['clientName']; ?></a></td>
                                <td><?php echo (isset($h['groupName']) && ($h['groupName'] !== '')?$h['groupName']:'--'); ?></td>
                                <td><?php echo (isset($h['tagName']) && ($h['tagName'] !== '')?$h['tagName']:'--'); ?></td>
                                <td><?php echo $h['age']; ?></td>
                                <td><?php echo $h['medicine_history']; ?></td>
                                <td><?php echo $h['allergy']; ?></td>
                                <td><?php echo $h['case']; ?></td>
                                <td>
                                    <a href="/index/Client/healthy?view=healthyBase&id=<?php echo $h['clientId']; ?>">详情</a>
                                </td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
                        </table>
                        <div class="page"><?php echo $page; ?> <div><?php echo $healthy['last_page']; ?>页，总共<?php echo $healthy['total']; ?>条数据</div></div>
                    </div>
                </div>
            </div>
        </div>
