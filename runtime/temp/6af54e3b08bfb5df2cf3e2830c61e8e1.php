<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:104:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/client/medical_history.html";i:1547789743;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1547601686;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1547707416;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>
                <small>服务对象管理&nbsp;>&nbsp;健康档案&nbsp;>&nbsp;既往病史</small>
                <a href="javascript:history.back(-1);" title="返回上一页"><i class="fa fa-reply"></i></a>
            </h5>
        </div>
        <div class="ibox-content c-medical-history">
            ...
            <div class="col-sm-12">
                <div class="ibox-title">
                    <h5>
                        <button class="btn btn-white btn-sm a-medical-history"><i class="fa fa-plus"></i> 添加病史</button>
                    </h5>
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                <?php if(is_array($history['data']) || $history['data'] instanceof \think\Collection || $history['data'] instanceof \think\Paginator): $k = 0; $__LIST__ = $history['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$h): $mod = ($k % 2 );++$k;?>
                                <tr>
                                    <td><?php echo $k; ?></td>
                                    <td><?php echo $h['descript']; ?></td>
                                    <td><?php echo $h['diagnostic_time']; ?></td>
                                    <td><?php echo $h['remarks']; ?></td>
                                    <td>
                                        <a href="javascript:;" class="e-medical-history" title="编辑"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                        <a href="javascript:;" class="d-medical-history" title="删除"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                </tbody>
                            </table>
                            <div class="page"><?php echo $page; ?> <div><?php echo $history['last_page']; ?>页，总共<?php echo $history['total']; ?>条数据</div></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    var $userId = '<?php echo $userId; ?>',
        $medicalHistoryList = '<?php echo json_encode($history["data"]); ?>';
</script>
</html>