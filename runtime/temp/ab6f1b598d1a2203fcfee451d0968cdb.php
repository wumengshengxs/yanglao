<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/auth/menu.html";i:1553496136;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1553750080;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1553750080;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-content">
            <div class="ibox-title">
                <h5>
                    <button class="btn btn-white btn-sm" onclick="addMenu(this)"><i class="fa fa-plus"></i> 添加分类</button>
                </h5>
            </div>
        ...
        layer.confirm(
            '确定该菜单?',
            {
                ...
                btn1:function(obj){
                    ...
                    $.post('/index/Auth/delmenu',{'id':mid},function(data){
                        if(data.code == 0){
