<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/server/view/work/index.html";i:1554082495;s:94:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/server/view/public/head.html";i:1552612121;s:94:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/server/view/public/foot.html";i:1552612121;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <div class="ibox-title" >
                        <div class="btn-group search">
                            ...
                            <div class="dropdown-menu">
                                <form class="form-horizontal" action="/server/work/index" method="get">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td><a href="/server/work/workDetails?id=<?php echo $vo['id']; ?>">查看</a>
                            </td>
