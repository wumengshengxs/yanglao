<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:98:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/qualitys/quality.html";i:1550208736;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/head.html";i:1548228499;s:93:"/Applications/XAMPP/xamppfiles/htdocs/pension_project/application/index/view/public/foot.html";i:1548228499;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="ibox-title">
                        ...
                        <h5>
                            <div class="btn-group search">
                                ...
                                <div class="dropdown-menu">
                                    <form class="form-horizontal" id="signupForm" action="javascript:search_quality()">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/index/Qualitys/QualityInfo?id=<?php echo $vo['id']; ?>"  class="btn btn-success btn-xs">工单质检</a>
                                </td>
                            </tr>
